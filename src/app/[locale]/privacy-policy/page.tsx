...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Arena Zero Movie Wiki',
    description: 'Arena Zero Movie Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Steam game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Arena Zero Movie Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Arena Zero Movie Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Arena Zero Movie Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Higgsfield AI or the creators of Arena Zero. All game content, trademarks, and assets are
