...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Arena Zero Movie Wiki',
    description: 'Copyright and intellectual property information for Arena Zero Movie Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Arena Zero Movie Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Arena Zero Movie Wiki',
      description: 'Copyright and intellectual property information for Arena Zero Movie Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Arena Zero Movie Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Arena Zero Movie Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Arena Zero Movie Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Arena Zero Creators</strong> - Creators of the Arena Zero series</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Arena Zero</strong> - Trademark of the game developers</li>
              <li><strong>Arena Zero Movie Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Arena Zero Movie Wiki.
            </p>
            ...
            <p>
              ...
              Arena Zero Movie Wiki<br />
              Email: <a href="mailto:dmca@arenazeromovie.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@arenazeromovie.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Arena Zero Movie Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Arena Zero Movie Wiki (arenazeromovie.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@arenazeromovie.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@arenazeromovie.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@arenazeromovie.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@arenazeromovie.wiki</a>
            </p>
            <p>
