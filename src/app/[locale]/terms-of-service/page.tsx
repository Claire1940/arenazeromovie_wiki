...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Arena Zero Movie Wiki",
    description: "Read the Terms of Service for Arena Zero Movie Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    keywords: [
      'terms of service',
      "Arena Zero Movie Wiki terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: "Terms of Service - Arena Zero Movie Wiki",
      description: "Terms and conditions for using Arena Zero Movie Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Arena Zero Movie Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Arena Zero Movie Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Arena Zero Movie Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Arena Zero Movie Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the AI series "Arena Zero". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Episode guides and series overview</li>
              <li>Plot and ending explained guides</li>
              <li>Character and cast information</li>
              <li>Trailer and production breakdown</li>
              <li>Review and reaction roundups</li>
              <li>Episode updates and release tracking</li>
            </ul>
            <p>
              <strong>Important:</strong> Arena Zero Movie Wiki is NOT affiliated with, endorsed by, or associated with
              Higgsfield AI or the official developers of Arena Zero. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Arena Zero Movie Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Higgsfield AI and/or the developers of Arena Zero. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ARENA ZERO MOVIE WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Arena Zero Movie Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:contact@arenazeromovie.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">contact@arenazeromovie.wiki</a>
            </p>
            <p>
